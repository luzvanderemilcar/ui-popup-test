...
let srcDataLink = "https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/GDP-data.json";

/*/ Asynchronous data fetching;
document.addEventListener("DOMContentLoaded", () => {
  let dataset = fetch(srcDataLink)
 .then(res => res.json())
...
let dates = dataset.map(d => timeParser(d[0]));
...
svg.selectAll("rect.bar")
  ...
  .on("mouseover", (d,i) => {
    ...
    .attr("data-gdp", rect.getAttribute("data-gdp"))
    .attr("x", rect.getAttribute("x"))
    .attr("y", rect.getAttribute("y")-( padding /2))
...
svg.append("g")
  .attr("transform", `translate(0,${h - padding})`)
    .attr("id", "x-axis")
    .call(xAxis);
    //.call(xAxis.ticks(d3.timeYear.range(1955, 2010, 10)));
